    ...
    <div className="space-y-4">
      ...
      <Card>
        <div className="flex items-center gap-4">
          <div className="grid h-12 w-12 place-items-center rounded-lg bg-slate-100"><Globe className="h-6 w-6 text-muted-foreground" /></div>
          <div className="flex-1">
            <h3 className="font-semibold">Linear</h3>
            <p className="text-sm text-muted-foreground">Sync issues bi-directionally with Linear.</p>
          </div>
          <button className="rounded-md border border-border px-3.5 py-2 text-sm font-medium text-slate-700 hover:bg-slate-50">Connect</button>
        </div>
      </Card>
    </div>
  );
